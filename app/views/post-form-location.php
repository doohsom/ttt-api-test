<html>
    ...
    <nav class="navbar navbar-light bg-light">
        <span class="navbar-brand mb-0 h1">Post Location</span>
    </nav>
    <div class="row">
    ...
    <div class="col-sm-6 bg-light p-3 border">
        ...
        <form action="/api/store-location" method="post">
            ...
            <div class="mb-3">
                <label class="form-label" for="userX">Position</label>
                <input type="text" class="form-control" name="positions" placeholder="Position" required>
            </div>
            <div class="mb-3">
                <label class="form-label" for="userX">User</label>
